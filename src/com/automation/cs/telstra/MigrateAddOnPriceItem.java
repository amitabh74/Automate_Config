...
public class MigrateAddOnPriceItem extends MigrateData implements IMigrateData {
    
    final static Logger logger = Logger.getLogger(MigrateAddOnPriceItem.class);   
    
    /**
  	 * Extracts the data from cspmb__Add_On_Price_Item__c object from source org
  	 * @param SourceConfig
  	 * @return String json
  	 */
	@Override
	...
	/**
	 * Insert Json to the cspmb__Add_On_Price_Item__c object in target Org
	 * @param String json
	 */
	@Override
