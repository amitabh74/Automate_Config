...
public class MigrateCommercialProducts implements IMigrateData{
    ...
    final static Logger logger = Logger.getLogger(MigrateCommercialProducts.class);   
    
    /**
  	 * Extracts the data from cspmb__Price_Item__c object from source org
  	 * @param SourceConfig
  	 * @return String json
  	 */
	@Override
	...
	/**
	 * Gets the total record count for object cspmb__Price_Item__c object
	 * @param conn
	 * @param baseUri
	 * @return totalSize
	 * @throws IOException 
	...
	private int getRecordCount(SFConnection conn, String baseUri) throws ClientProtocolException, IOException{
        ...
        String uri = baseUri + "/query?q=Select+count(+Id+)+from+cspmb__Price_Item__c";
        logger.debug("Query URL: " + uri);
	...
	/**
	 * Insert Json to the cspmb__Price_Item__c object in target Org
	 * @param String json
	 */
	@Override
